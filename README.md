...
1. **Codice sorgente** su repository Git (con almeno 10 commit significativi)
2. **Documentazione API** in formato Markdown o Swagger/OpenAPI
3. **Schema ER** del database (anche disegnato a mano o con strumento grafico)
4. **Breve documento di progetto**: scelte architetturali, divisione del lavoro, difficoltà incontrate